<template>
    ...
    <div class="nav-container page-component">
      ...
      <div class="nav left-nav">
        <div class="nav-item ">
          <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hospital/'+this.hospital.hoscode+'\''">预约挂号 </span>
        </div>
        <div class="nav-item selected">
          <span class="v-link selected dark" :onclick="'javascript:window.location=\'/hospital/detail/'+this.hospital.hoscode+'\''"> 医院详情 </span>
        </div>
        <div class="nav-item">
          <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hospital/notice/'+this.hospital.hoscode+'\''"> 预约须知 </span>
        </div>
        ...
        <div class="hospital-detail">
          <div class="common-header">
            <div class="title-wrapper"><span class="hospital-title">{{ hospital.hosname }}</span>
              <div class="icon-wrapper"><span class="iconfont"></span> {{ hospital.param.Hostype }}</div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    init() {
      hospitalApi.getHospitalByHosCode(this.hoscode).then(response => {
