          ...
          <div class="sub-dept-container">
            <div v-for="(item,index) in departmentVoList" :key="item.id" :class="index == 0 ? 'selected' : ''"
              ...
              <div class="sub-item-wrapper">
                <div v-for="it in item.departmentList" :key="it.id" class="sub-item" @click="schedule(it.depcode)"><span
...
export default {
  ...
  methods: {
    init() {
      ...
      departmentApi.getDepartmentTree(this.hoscode).then(response => {
